...
| R-004 | Frontend automated tests insufficient for critical flows | High | Frontend Lead | Add auth/payments/governance/wallet tests and run in CI; wallet detection coverage added as first Week 4 frontend slice | 2026-06-14 | In Progress | apps/frontend/src/__tests__/wallet-detection-enforcer.test.tsx |
