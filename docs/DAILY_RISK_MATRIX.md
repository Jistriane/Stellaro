...
| R-002 | Financial flows still operating in stub mode | Critical | Backend Lead | Move PIX/x402/Etherfuse to live in staging with alerts | 2026-06-07 | Open | docs/BACKEND_INTEGRATION_POINTS.md |
| R-003 | DEX integration pending | High | Smart Contract Lead | Implement runtime integration and validate ABI compatibility | 2026-06-10 | Open | docs/SMART_CONTRACT_API_REFERENCE.md |
| R-004 | Frontend automated tests insufficient for critical flows | High | Frontend Lead | Add auth/payments/governance/wallet tests and run in CI | 2026-06-14 | Open | docs/TESTING.md |
| R-005 | Backend low-coverage modules in guards/controllers | High | Backend Lead | Expand specs and enforce coverage trend monitoring | 2026-06-14 | Open | docs/TEST_COVERAGE_REPORT.md |
