...
| R-004 | Frontend automated tests insufficient for critical flows | High | Frontend Lead | Add auth/payments/governance/wallet tests and run in CI; wallet detection, governance vote, login validation, passkey session, dashboard, stablecoin, profile auth, wallet fallback, loans, portfolio, governance page, trading, chat, Pix, notifications, docs, home, help, learn, recurring payments page, and settings coverage added as first Week 4 frontend slices | 2026-06-14 | In Progress | apps/frontend/src/__tests__/settings-page.test.tsx |
