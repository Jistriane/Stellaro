...
```bash
# Add ~10-15 XLM to account:
# GCKZ35K7GMUJBFKBOS2YM7FUHATM5FHHFGH7AVNGC5TXLFGV265G33QX

# Current balance: 21.02 XLM
# Required: ~2 XLM per contract × 6 contracts = ~12 XLM total
# Recommended: +15 XLM (includes buffer for testing)
```
...
3. **Contract deployment costs ~10-15 XLM total** for all 6 contracts on mainnet (NOT 150 XLM!)
