...
## Summary
Successfully initialized the ZK Verifier smart contract on Stellar Testnet using `@stellar/stellar-sdk` after Stellar CLI exhibited persistent BytesN<32> type handling issues across versions 23.1.4 and 23.2.1.
...
- **Hash**: `9a6dea7e48df2c7447a47a804b4cb77aa5b70cdb8762904787db7a9d2e6395f0`
...
```typescript
Admin Address:      GDHIZHAWV7TC6RKI2KXQ23XVRQ23UPJWSODCQHIRZQO22ANVGH7BM4ZD
Verification Key:   0x0101010101010101010101010101010101010101010101010101010101010101 (32 bytes)
Min Score:          700
```
