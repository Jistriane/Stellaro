...
export class X402Controller {
  ...
  @Get('status')
  @ApiOperation({ summary: 'Returns x402 settlement rail status and config surface' })
  getStatus() {
    return this.x402Service.getStatus();
  }

  @Post('quote')
  @ApiOperation({ summary: 'Generates a base x402 quote for facilitator settlement' })
