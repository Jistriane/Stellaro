...
describe('RiskService', () => {
  ...
  it('should ingest signals deterministically', async () => {
    const res = await service.ingestSignals({
      signals: [],
      context: { userId: 'U1' },
    } as any);
  ...
  describe('Signal Ingestion', () => {
    it('should handle multiple signals', () => {
      ...
      const res = service.ingestSignals({
        signals,
        context: { userId: 'U4' },
      } as any);
    ...
    it('should process signals with different user contexts', async () => {
      const res1 = await service.ingestSignals({
        signals: [],
        context: { userId: 'U6' },
      } as any);
      const res2 = await service.ingestSignals({
        signals: [],
        context: { userId: 'U7' },
      } as any);
