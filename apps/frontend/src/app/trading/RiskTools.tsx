    ...
    <div className="space-y-3 text-sm">
      <div className="grid grid-cols-2 gap-3">
        <label className="flex flex-col gap-1">
          <span className="text-slate-400">Entrada ({quote})</span>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div>
          <div className="text-slate-400">Risco</div>
        ...
        <div>
          <div className="text-slate-400">Risco/Retorno</div>
          <div className="text-slate-200">{rr}</div>
        </div>
      </div>

      <div className="text-xs text-slate-500">Dica: mantenha RR ≥ 1.5:1. Configure stop e take diretamente ao enviar a ordem.</div>
    </div>
  );
}
